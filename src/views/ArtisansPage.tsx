        ...
        <div className="container mx-auto px-4 lg:px-8 py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground">
              Meet the skilled craftspeople who bring our furniture to life. Their expertise, 
              dedication, and passion for excellence are the heart of PoyBash Furniture.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Each piece of PoyBash furniture is crafted by skilled artisans who have dedicated 
                years to mastering their craft. Our team combines traditional woodworking techniques 
                passed down through generations with modern design sensibilities.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                From selecting the perfect wood grain to applying the final finish, every step is 
                executed with precision and care. Our artisans don't just build furniture—they 
                create heirlooms that will be treasured for years to come.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground">
                Our craftspeople bring unique skills and unwavering dedication to every project.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center space-y-4 p-6 rounded-lg border bg-card">
                ...
                <h3>Passion</h3>
                <p className="text-muted-foreground">
                  Genuine love for the craft drives exceptional attention to detail
                </p>
              </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Meet some of the talented individuals who make PoyBash Furniture exceptional.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8">
              {artisans.map((artisan) => (
                <div key={artisan.name} className="flex gap-6 p-6 rounded-lg border bg-card">
          ...
          <div className="bg-secondary/30 rounded-lg p-12 text-center max-w-3xl mx-auto">
            <blockquote className="space-y-4">
              <p className="text-muted-foreground italic leading-relaxed">
                "Every piece we create carries a part of us. When customers bring our furniture 
                into their homes, they're not just getting a chair or table—they're getting 
                craftsmanship, care, and a commitment to quality that you can feel in every detail."
              </p>
              <footer className="pt-4 border-t">
                <p><strong>Ricardo Santos</strong></p>
                <p className="text-muted-foreground">Master Carpenter, PoyBash Furniture</p>
              </footer>
            </blockquote>
          </div>
        </div>
