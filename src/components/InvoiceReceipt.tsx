      ...
      <Card className="print-invoice print:shadow-none print:border-none">
        <CardContent className="p-4 sm:p-6" id="invoice-content">
              ...
              <tbody>
                {order.items.map((item, index) => (
                  <tr key={index} className="border-b border-gray-100">
                    ...
                    <td className="py-3 px-2 text-center align-top text-xs">
                      {item.quantity}
                    </td>
                    <td className="py-3 px-2 text-right align-top whitespace-nowrap text-xs">
                      ₱{item.price.toFixed(2)}
                    </td>
                    <td className="py-3 pl-2 text-right align-top whitespace-nowrap text-xs font-medium">
              ...
              {order.reservationFee && order.reservationFee > 0 && (
                <div className="flex justify-between text-orange-600">
                  ...
                  <span className="font-medium">
                    ₱{(order.total - order.reservationFee).toFixed(2)}
                  </span>
                </div>
              )}
          ...
          <div className="text-center text-xs space-y-1">
            ...
            <p className="text-muted-foreground text-[11px]">
              For questions about your order, visit us on Facebook: Poybash
              Furniture
            </p>
            <p className="text-muted-foreground text-[11px]">
              Call us at +63 932 549 0596
            </p>
          </div>
        </CardContent>
      </Card>
